...
api_key = 'b4c837b40459409e7425e994686c1b11' # get yours at https://darksky.net/dev
units = '' # set to si for metric, leave blank for imperial

def auto_loc_lookup():
  try:
    location = check_output(["/Users/arielallon/bitbar/weather/whereami"])
    whereami = location.split()
    return {'loc': whereami[1] + ',' + whereami[3]}
